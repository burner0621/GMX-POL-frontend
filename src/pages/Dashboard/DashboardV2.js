...
export default function DashboardV2() {
  ...
  const { data: currentFees } = useSWR(
    ...
    infoTokens[AddressZero].contractMinPrice
        ...
        renderContent={() => {
          return (
            <>
              ...
              <br />
              <div>
                <ExternalLink href="https://docs.POL.finance">
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <TooltipComponent
                      ...
                      position="right-bottom"
                      renderContent={() => (
                        <span>{t`Assets Under Management: $POL staked (All chains) + $PLP pool (${chainName})`}</span>
                      )}
                    />
                  </div>
                </div>
                ...
                <div className="stats-block">
                  <div className="App-card-title">
                    <div className="App-card-title-mark">
                      <div className="App-card-title-mark-icon">
                        <img src={gmx40Icon} alt="$POL Token Icon" width="40px" />
                      </div>
                      <div className="App-card-title-mark-info">
                        <div className="App-card-title-mark-title">$POL</div>
                        <div className="App-card-title-mark-subtitle">$POL</div>
                      </div>
                      <div>
                  ...
                  <div className="App-card-content">
                    ...
                    <div className="App-card-row">
                      ...
                      <div>{formatAmount(totalGmxSupply, GMX_DECIMALS, 0, true)} $POL</div>
                    </div>
                    <div className="App-card-row">
                      <div className="label">

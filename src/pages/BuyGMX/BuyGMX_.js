          ...
          <div className="section-title-block">
            <div className="section-title-content">
              ...
              <div className="Page-description">
                <Trans>ETH is needed on Arbitrum to purchase $POL.</Trans>
                <br />
              </div>
            </div>
          </div>
        ...
        {chainId === MAINNET && (
          <div className="section-title-block">
            <div className="section-title-content">
              ...
              <div className="Page-description">
                <Trans>ETH is needed on Ethereum to purchase $POL.</Trans>
                <br />
                {/* <Trans>
                  To purchase $POL on <span onClick={() => onNetworkSelect(ARBITRUM)}>Arbitrum</span>, please change your
                  network.
                </Trans> */}
              </div>
            </div>
        ...
        {chainId === ARBITRUM && (
          <div className="BuyGMXGLP-panel">
            ...
            <div className="buy-card">
              <div className="section-title-content">
                <div className="card-title">
                  <Trans>Buy $POL Bonds</Trans>
                </div>
              </div>
              <div className="App-card no-height">
                <div className="App-card-content no-title">
                  <div className="BuyGMXGLP-description">
                    <Trans>$POL bonds can be bought on Olympus Pro with a discount and a small vesting period:</Trans>
                  </div>
                  <div className="buy-gmx">

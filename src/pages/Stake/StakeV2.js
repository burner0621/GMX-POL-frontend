    ...
    <div className="StakeModal">
      <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title}>
        ...
        {burnAmount && burnAmount.gt(0) && rewardReductionBasisPoints && rewardReductionBasisPoints.gt(0) && (
          <div className="Modal-note">
            Unstaking will burn&nbsp;
            <a href="https://docs.POL.financerewards" target="_blank" rel="noopener noreferrer">
        ...
        <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title} className="non-scrollable">
          <div className="Exchange-swap-section">
            ...
            <div className="Exchange-swap-section-bottom">
              ...
              <div className="PositionEditor-token-symbol">esPOL</div>
            </div>
          </div>
          <div className="VesterDepositModal-info-rows">
            <div className="Exchange-info-row">
              ...
              <div className="align-right">{formatAmount(balance, 18, 2, true)} esPOL</div>
            </div>
            <div className="Exchange-info-row">
              <div className="Exchange-info-label">
                    ...
                    return (
                      <div>
                        ...
                        <StatsTooltipRow
                          showDollar={false}
                          label={t`Deposited`}
                          value={`${formatAmount(vestedAmount, 18, 2, true)} esPOL`}
                        />
                        <StatsTooltipRow
                          showDollar={false}
                          label={t`Max Capacity`}
                          value={`${formatAmount(maxVestableAmount, 18, 2, true)} esPOL`}
                        />
                      </div>
                    );
                  }}
                        ...
                        {amount && nextReserveAmount.gt(maxReserveAmount) && (
                          <>
                            ...
                            <Trans>
                              ...
                              {stakeTokenLabel} to vest {formatAmount(amount, 18, 2, true)} esPOL.
                            </Trans>
                          </>
                        )}
                      </>
      ...
      <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title}>
        <Trans>
          <div>
            ...
            <br />
            <br />
            esPOL tokens that have been converted to $POL will remain as $POL tokens.
            <br />
            <br />
            To claim $POL tokens without withdrawing, use the "Claim" button under the Total Rewards section.
            <br />
            <br />
          </div>
        </Trans>
...
function CompoundModal(props) {
  ...
  const getPrimaryText = () => {
    if (isApproving) {
      return t`Approving $POL...`;
    }
    if (needApproval) {
      return t`Approve $POL`;
    }
    if (isCompounding) {
...
export default function StakeV2({ setPendingTxns, connectWallet }) {
  ...
  const showStakeEsGmxModal = () => {
    setIsStakeModalVisible(true);
    setStakeModalTitle(t`Stake esPOL`);
    setStakeModalMaxAmount(processedData.esGmxBalance);
    setStakeValue("");
    setStakingTokenSymbol("esPOL");
  ...
  const showGmxVesterDepositModal = () => {
    ...
    setVesterDepositTitle(t`$POL Vault`);
    setVesterDepositStakeTokenLabel("staked $POL + esPOL + Multiplier Points");
  ...
  const showGmxVesterWithdrawModal = () => {
    ...
    setVesterWithdrawTitle(t`Withdraw from $POL Vault`);
  ...
  const showUnstakeGmxModal = () => {
    ...
    setUnstakeModalTitle(t`Unstake $POL`);
    ...
    setUnstakeValue("");
    setUnstakingTokenSymbol("$POL");
    setUnstakeMethodName("unstakeGmx");
  };

  const showUnstakeEsGmxModal = () => {
    setIsUnstakeModalVisible(true);
    setUnstakeModalTitle(t`Unstake esPOL`);
        ...
        renderContent={() => {
          return (
            <Trans>
              ...
              <a href="https://docs.POL.financerewards#multiplier-points" rel="noreferrer" target="_blank">
                More info
              </a>
              .
            </Trans>
  ...
  if (totalRewardTokensAndGlp && totalRewardTokensAndGlp.gt(0)) {
    ...
    if (processedData.gmxInStakedGmx && processedData.gmxInStakedGmx.gt(0)) {
      gmxAmountStr = formatAmount(processedData.gmxInStakedGmx, 18, 2, true) + " $POL";
    }
    let esGmxAmountStr;
    if (processedData.esGmxInStakedGmx && processedData.esGmxInStakedGmx.gt(0)) {
      esGmxAmountStr = formatAmount(processedData.esGmxInStakedGmx, 18, 2, true) + " esPOL";
    }
    let mpAmountStr;
    ...
    <div className="default-container page-layout">
      ...
      <div className="section-title-block">
        ...
        <div className="section-title-content">
          ...
          <div className="Page-description">
            <Trans>Stake $POL and $PLP to earn rewards.</Trans>
          </div>
      ...
      <div className="StakeV2-content">
        <div className="StakeV2-cards">
          <div className="App-card StakeV2-gmx-card">
            <div className="App-card-title">$POL</div>
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "gmxBalance", 18, 2, true)} $POL ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "gmxInStakedGmx", 18, 2, true)} $POL ($
              ...
              <div className="App-card-row">
                ...
                {totalGmxSupply && (
                  <div>
                    {formatAmount(totalGmxSupply, 18, 0, true)} $POL ($
              ...
              <div className="App-card-options">
                <Link className="App-button-option App-card-option" to="/buy_POL">
                  <Trans>Buy $POL</Trans>
                </Link>
                {active && (
          ...
          <div className="App-card">
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "esGmxBalance", 18, 2, true)} esPOL ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "esGmxInStakedGmx", 18, 2, true)} esPOL ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "stakedEsGmxSupply", 18, 0, true)} esPOL ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatAmount(esGmxSupply, 18, 0, true)} esPOL ($
      ...
      <div>
        <div className="Tab-title-section">
          ...
          <div className="Page-description">
            <Trans>
              Convert esPOL tokens to $POL tokens.
              <br />
              Please read the{" "}
              <a href="https://docs.POL.financehow-it-works/rewards" target="_blank" rel="noopener noreferrer">
                vesting details
              </a>{" "}
            ...
            <div className="App-card StakeV2-gmx-card">
              ...
              <div className="App-card-content">
                        ...
                        return (
                          <div>
                            <Trans>
                              ...
                              converted to $POL from the{" "}
                              {formatKeyAmount(vestingData, "gmxVesterVestedAmount", 18, 4, true)} esPOL deposited for
                              vesting.
                            </Trans>
                          </div>
                        );
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <Tooltip
                      handle={`${formatKeyAmount(vestingData, "gmxVesterClaimable", 18, 4, true)} $POL`}
                      position="right-bottom"
                      renderContent={() => (
                        <Trans>
                          {formatKeyAmount(vestingData, "gmxVesterClaimable", 18, 4, true)} $POL tokens can be
            ...
            <div className="App-card StakeV2-gmx-card">
              ...
              <div className="App-card-content">
                        ...
                        return (
                          <div>
                            <Trans>
                              ...
                              converted to $POL from the{" "}
                              {formatKeyAmount(vestingData, "glpVesterVestedAmount", 18, 4, true)} esPOL deposited for
                              vesting.
                            </Trans>
                          </div>
                        );
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <Tooltip
                      handle={`${formatKeyAmount(vestingData, "glpVesterClaimable", 18, 4, true)} $POL`}
                      position="right-bottom"
                      renderContent={() => (
                        <Trans>
                          {formatKeyAmount(vestingData, "glpVesterClaimable", 18, 4, true)} $POL tokens can be
                          claimed, use the options under the Total Rewards section to claim them.
                        </Trans>
                      )}
                    />

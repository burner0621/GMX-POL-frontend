        ...
        <div>
          ...
          <div className="content">
            ...
            <div className="section">
              ...
              <p className="body-text">
                zomi.finance is not part of any transaction on the blockchain networks underlying the $POL Protocol;
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    ...
                    the $POL Protocol and the Interface (zomi.finance) deployed on IPFS is open-sourced. Except as
            ...
            <div className="section">
              ...
              <p className="body-text">
                zomi.finance is an informational site for the $POL Protocol. zomi.finance does not operate an

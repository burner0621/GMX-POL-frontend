...
export default function BeginAccountTransfer(props) {
  ...
  const getError = () => {
    ...
    if (hasVestedGmx) {
      return t`Vested $POL not withdrawn`;
    }
    if (hasVestedGlp) {
      ...
      <div className="Page-title-section">
        ...
        <div className="Page-description">
          <Trans>
            ...
            <br />
            This will transfer all your $POL, esPOL, $PLP and Multiplier Points to your new account.
            <br />
            Transfers are only supported if the receiving account has not staked $POL or $PLP tokens before.
            <br />
        ...
        <div className="input-form">
          ...
          <div className="BeginAccountTransfer-validations">
            <ValidationRow isValid={!hasVestedGmx}>
              <Trans>Sender has withdrawn all tokens from $POL Vesting Vault</Trans>
            </ValidationRow>
            ...
            <ValidationRow isValid={!hasStakedGmx}>
              <Trans>Receiver has not staked $POL tokens before</Trans>
            </ValidationRow>

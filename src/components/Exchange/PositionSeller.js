        ...
        return (
          <div className="Confirmation-box-warning">
            <Trans>
              ...
              <ExternalLink href="https://docs.POL.financetrading#minimum-price-change">
                pending profit
              </ExternalLink>{" "}
              of {deltaStr}. <br />
            </Trans>
      ...
      return (
        <div className="Confirmation-box-warning">
          <Trans>
            ...
            <ExternalLink href="https://docs.POL.financetrading#minimum-price-change">profit</ExternalLink> of{" "}
            {deltaStr}. <br />
          </Trans>
          <Trans>
            Profit price: {position.isLong ? ">" : "<"} ${formatAmount(profitPrice, USD_DECIMALS, 2, true)}. This rule
                  ...
                  renderContent={() => (
                    <div>
                      ...
                      <div className="PositionSeller-fee-item">
                        <Trans>
                          <ExternalLink href="https://docs.POL.financetrading#fees">More Info</ExternalLink> about
                          fees.
                        </Trans>
                      </div>
                    </div>

...
const footerLinks = {
  home: [
    ...
    { text: t`Referral Terms`, link: "https://POL.gitbook.referrals", external: true },
    { text: t`Media Kit`, link: "https://docs.POL.finance", external: true },
...
const socialLinks = [
  { link: "https://twitter.com/POL.finance", name: "Twitter", icon: twitterIcon },
  // { link: "https://POLfinance.medium.com/", name: "Medium", icon: mediumIcon },
  { link: "https://github.com/POL", name: "Github", icon: githubIcon },
  { link: "https://t.me/POLchat", name: "Telegram", icon: telegramIcon },

...
export function RedirectPopupModal({
  ...
  return (
    <Modal
      ...
      label={t`Launch App`}
    >
      <Trans>You are leaving $POL.io and will be redirected to a third party, independent website.</Trans>
      <br />
      <br />
      <Trans>
        The website is a community deployed and maintained instance of the open source{" "}
        <ExternalLink href="https://github.com/POL/">$POL front end</ExternalLink>, hosted and
      ...
      <Trans>
        ...
        <ExternalLink href="https://docs.POL.financeapp-links">docs</ExternalLink>.
        <br />
        <br />

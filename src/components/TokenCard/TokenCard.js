    ...
    <div className="Home-token-card-options">
      <div className="Home-token-card-option">
        <div className="Home-token-card-option-icon">
          <img src={gmxBigIcon} alt="mmxBigIcon" width="40px" /> $POL
        </div>
        <div className="Home-token-card-option-info">
          <div className="Home-token-card-option-title">
            <Trans>$POL is the utility and governance token. Accrues 30% of the platform's generated fees.</Trans>
          </div>
          ...
          <div className="Home-token-card-option-action">
            ...
            <ExternalLink
              href="https://docs.POL.financetokenomics/mmx"
      ...
      <div className="Home-token-card-option">
        ...
        <div className="Home-token-card-option-info">
          ...
          <div className="Home-token-card-option-action">
            ...
            <a
              href="https://docs.POL.financetokenomics/mlp"
              target="_blank"
              rel="noreferrer"
              className="default-btn read-more"
            >
